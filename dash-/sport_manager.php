...
?>
      ...
      <nav class="navbar navbar-default text-center">
         <div class="collapse navbar-collapse" id="sports-bar-nav-menu">
            <ul class="nav navbar-nav">
              <li class="active">
    		<a href="add_sport.php">&nbsp;&nbsp;<span class="glyphicon glyphicon-plus">&nbsp;</span>Add </a>
               </li>
              <li>
   ...
   <div class="row table-row">
      <h2 class="sub-header">Sports Table</h2>
...
<?php
	$db_object	=	new db();
	$resource	=	$db_object->get_all_sports();
...
do{
	?>
                  ...
                  <td><a href="active.php?id=<?php echo $row['id'];?>&tb=sport">
						<?php echo status($row['status']);?>
                  </a>
                  </td>
                  <td><a href="edit_sport.php?id=<?php echo $row['id'];?>">Edit</a></td>
                  <td><a href="delete_sport.php?id=<?php echo $row['id'];?>">Delete</a></td>                  
                </tr>
   <?php
